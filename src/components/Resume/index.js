...
function Resume() {
  return (
    <section class="container">
      ...
      <div>
        <div class="mt-5">
          <h2 className="top-title">Tom Barber</h2>
          <ul>
            <li>
          ...
          <p class="mt-5">
            <a href="https://www.linkedin.com/in/tom-barber-4b3259127/">
              <img
          ...
          <a
            href="https://github.com/trb5160/Portfolio_3.0/blob/main/assets/images/Current%20Resume.pdf"
            class="link"
          >
            Download Resume
          </a>
